...
has been registered with IANA (registration date 2026-07-21) and is listed
...
- The `application/vnd.portableweb+zip` media type has been formally
  registered with IANA (registration date 2026-07-21). Section 7.1 now
  notes the registration and links to the IANA Media Types registry entry.

- Editorial clarifications throughout; no other normative changes.
